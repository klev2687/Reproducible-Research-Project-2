...
The file has column EVTYPE that describes the Event Type that was recorded for the period. The data needs to be filtered to inlcude only valid event types as stated in the [Storm Data Documentation][2].  
...
[2]: http://www.nws.noaa.gov/directives/sym/pd01016005curr.pdf "Storm Data Documentation"